...
class Customercustomerdemo(models.Model):
    customerid = models.OneToOneField('Customers', models.DO_NOTHING, db_column='CustomerID', primary_key=True)  # Field name made lowercase.
...
class Employeeterritories(models.Model):
    employeeid = models.OneToOneField('Employees', models.DO_NOTHING, db_column='EmployeeID', primary_key=True)  # Field name made lowercase.
...
class Inventory(models.Model):
    ...
    itemsinstore = models.IntegerField(db_column='ItemsInStore')  # Field name made lowercase.
    itemsinwarehouse = models.IntegerField(db_column='ItemsInWarehouse')  # Field name made lowercase.
...
class Productspricehistory(models.Model):
    productname = models.CharField(db_column='ProductName', max_length=40, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    unitprice = models.DecimalField(db_column='UnitPrice', max_digits=19, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    change = models.CharField(db_column='Change', max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS')  # Field name made lowercase.
    lasttimechecked = models.DateTimeField(db_column='LastTimeChecked')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'ProductsPriceHistory'
...
class Salesbycategoryandyear(models.Model):
    category = models.IntegerField()
    year = models.IntegerField(blank=True, null=True)
    sales = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'SalesByCategoryAndYear'


class Salesbycategoryandyearpivot(models.Model):
    category = models.IntegerField(db_column='Category')  # Field name made lowercase.
    number_1996 = models.DecimalField(db_column='1996', max_digits=19, decimal_places=4, blank=True, null=True)  # Field renamed because it wasn't a valid Python identifier.
    number_1997 = models.DecimalField(db_column='1997', max_digits=19, decimal_places=4, blank=True, null=True)  # Field renamed because it wasn't a valid Python identifier.
    number_1998 = models.DecimalField(db_column='1998', max_digits=19, decimal_places=4, blank=True, null=True)  # Field renamed because it wasn't a valid Python identifier.

    class Meta:
        managed = False
        db_table = 'SalesByCategoryAndYearPivot'
...
class T(models.Model):
    col1 = models.TextField(db_column='Col1', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
...
class Log(models.Model):
    msg = models.CharField(max_length=50, db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)
